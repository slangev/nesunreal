...
public:
	...
	// Length Counter information
	uint16 LengthCounter; // APU Length Counter
	bool bChannelEnabled = false; // Channel enabled
	bool bLengthCounterHalt; // Halt the Length Tick
	uint16 LengthLoad; // Value to reload length counter
