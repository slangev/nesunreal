...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FMyAwesomeTest, "Nes.LDs", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
...
bool FMyAwesomeTest::RunTest(const FString& Parameters)
{
